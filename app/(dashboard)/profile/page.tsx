...
export default function ProfilePage() {
  ...
  return (
    <section className="rounded-2xl bg-card p-6 md:p-8 shadow-sm ring-1 ring-border">
      <h1 className="text-balance text-2xl font-semibold text-foreground">Profil</h1>
      <p className="mt-2 text-muted-foreground">Gérez votre profil, préférences et compte.</p>
      ...
      <div className="mt-6 grid gap-6 md:grid-cols-3">
        ...
        <div className="rounded-xl bg-background p-4 ring-1 ring-border">
          <h3 className="mb-3 font-medium text-foreground">Préférences</h3>
          <div className="flex items-center justify-between py-2">
            <span className="text-sm text-foreground">Notifications</span>
            <Switch checked={notifications} onCheckedChange={setNotifications} />
          </div>
          <div className="flex items-center justify-between py-2">
            <span className="text-sm text-foreground">Mode économie</span>
            <Switch checked={energySaving} onCheckedChange={setEnergySaving} />
          </div>
        </div>

        <div className="rounded-xl bg-background p-4 ring-1 ring-border">
          <h3 className="mb-3 font-medium text-foreground">Raccourcis</h3>
